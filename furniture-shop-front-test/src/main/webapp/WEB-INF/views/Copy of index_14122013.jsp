...
<p>Поэтому работать с нами надежно, просто и выгодно.</p></div>
	<!--	<div id="forma">
		...
		<div id="product1">
			<div class="trproduct">
				<img src="/resources/images/struktyra_glavnaya_1.png" alt="Новинки"/>
				<div class="pop l1"><span>Новинки</span></div>
			</div>
			<div class="trproduct">
				<img src="/resources/images/struktyra_glavnaya_2.png" alt="Популярные"/>
				<div class="pop l2"><span>Популярные</span></div>
			</div>
			<div class="trproduct">
				<img src="/resources/images/struktyra_glavnaya_3.png" alt="Акции"/>
	...
	<div id="vse"><a class="hv" href="#"><h2 style="margin-left: 10px;">Вся мебель:</h2></a>
		...
		<div class="product">
			...
			<img class="photovse" src="http://mebelvopt.ru/resources/img/${furCal.smallImageFile }" alt="${furCal.itemName }"/>
			<!-- <div class="zvezda"><img src="/resources/images/zvezda.png" alt="Цены по запросу"/><h3>Цена по запросу</h3></div>  -->
		...
		<div class="product">
			...
			<img class="photovse" src="/resources/images/product4.png" alt="Спальня Виво"/>
			<div class="zvezda"><img src="/resources/images/zvezda.png" alt="Цены по запросу"/><h3>Цена по запросу</h3></div>
